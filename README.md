...
Frontend setup is now complete. If you want to test the features by running both the frontend and backend on your local machine, please proceed with the Backend Setup below.
